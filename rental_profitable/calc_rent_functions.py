...
class CalculatingRentProfitable:
    ...
    def __is_renting_profitable(self):
        if self.present_apartment_value > self.property_appreciation:
            self.profitable: bool = True
        else:
            self.is_profitable: bool = False
        if self.present_apartment_value_up > self.property_appreciation:
            self.profitable_up: bool = True
        else:
            self.profitable_up: bool = False
        if self.present_apartment_value_down > self.property_appreciation:
            self.profitable_down: bool = True
        else:
            self.is_profitable_down: bool = False
